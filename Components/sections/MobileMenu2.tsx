...
export default function Mobile2 () {
    return (
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-6 px-6 md:px-10 lg:pl-20 lg:pr-20 pt-10 md:pt-12 lg:pt-15">
            <div className="w-full md:w-1/2 text-center md:text-left">
                <h1 className="text-[28px] sm:text-[32px] md:text-[34px] lg:text-[36px] font-semibold leading-tight">
            ...
            <div className="flex justify-center w-full md:w-auto">
                <img src="./images/image2.jpeg" alt="" className="w-[260px] sm:w-[300px] md:w-[360px] lg:size-105 h-auto" />
            </div>
        </div>
    );
}