...
export default function CTASection () {
    return(
        <div className="flex flex-col md:flex-row items-center justify-between mt-20 gap-10 md:gap-6 pt-10 md:pt-12 lg:pt-15 px-6 md:px-10 lg:px-20">
            <div className="w-full md:w-1/2 text-center md:text-left">
                ...
                target="-blank"><img src="./images/store2.svg" alt="" className="h-10 md:h-11 lg:h-auto w-auto cursor-pointer" /></Link>
                <Link href="https://www.apple.com/app-store/"
                target="-blank"><img src="./images/store1.svg" alt="" className="h-10 md:h-11 lg:h-auto w-auto cursor-pointer" /></Link>
                </div>
            </div>
