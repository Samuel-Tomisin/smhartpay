...
export default function CreateAccount() {
  ...
  function handleTabSwitch(tab: "individual" | "corporate") {
    setActiveTab(tab);
    router.push(tab === "individual" ? "/register" : "/register/corporate");
  }
  ...
  function handleContinue() {
    if (activeTab === "individual") {
      ...
      router.push("/register/corporate/verify");
    }
  }
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex flex-col items-center px-4 sm:px-8 py-10 sm:py-16">
        <div className="w-full max-w-[460px]">
          ...
          {/* Heading */}
          <h1 className="text-2xl sm:text-[28px] font-bold text-[#0d1b2e] mb-1">
            Create Account
          </h1>
            ...
            <div className="flex gap-2 mb-6 relative" ref={dropdownRef}>
              ...
              >
                ...
                <svg
                  ...
                  className={`w-4 h-4 text-[#647FA1] transition-transform duration-200 ${dropdownOpen ? "rotate-180" : ""}`}
                          ...
                          <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm hover:bg-[#EEF3FB] transition-colors duration-150 cursor-pointer ${
                              selectedCountry.country === c.country
                                ? "bg-[#EEF3FB] text-[#034EA2] font-semibold"
                                : "text-[#0d1b2e]"
                            }`}
                          >
              ...
              <input
                ...
                className="flex-1 px-4 py-3 rounded-xl border border-gray-200 bg-[#F8FAFC] text-[#0d1b2e] text-sm sm:text-[15px] placeholder:text-[#aab8cc] 
                outline-none focus:border-[#034EA2] focus:ring-2 focus:ring-[#034EA2]/10 transition-all duration-200"
              />
            </div>
          )}
